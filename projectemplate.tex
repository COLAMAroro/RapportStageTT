...
Certaines documentation étant dépassés ou simplement inexistante, il m'a été demandé d'améliorer la documentation général du département système. En outre, j'ai participé à la création d'une fiche de procédure précise sur la résolution des tickets GLPI, la correction d'informations dépassés dans les informations sur la procédure de réinstallation d'une machine, ou encore des règles concernant les salles de réunion. Ce travail consistait aussi à porter et rassembler sur \textit{Overmind}(Outil interne à l'entreprise) les documentations précédamment existante. Par exemple, j'ai beaucoup travaillé sur la création de documentation pour \nameref{subsubsec:Chocolatey}, afin de permettre aux autres membre du département système de pouvoir créer et configurer leur propres paquets Chocolatey.
...
Comme pour le précédent déménagement, j'ai aidé aux débranchement des machines des utilisateurs.
...
Ce stage m'a permis d'acquérire énormément d'experience diverse comme la gestion de parc informatique théorique comme pratique ou le développement sur Windows par exemple
